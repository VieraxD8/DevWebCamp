...
$router->get('/api/ponente', [APIRegalos::class, 'index']);
...
$router->get('/devwebcamp', [PaginaController::class, 'evento']);
$router->get('/paquetes', [PaginaController::class, 'paquetes']);
$router->get('/workshops-conferecias', [PaginaController::class, 'conferencias']);
