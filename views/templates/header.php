<header class="header">
    <div class="header__contenedor">
        ...
        <div class="header__contenido">
            ...
            <p class="header__texto">Octubre 5-6 del 2024</p>
...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            ...
            <a href="/workshops-conferecias" class="navegacion__enlace <?php echo pagina_actual('/workshops-conferecias') ? 'navegacion__enlace--actual' : ''; ?>">Workshops / Conferencias</a>
            <a href="/registro" class="navegacion__enlace <?php echo pagina_actual('/registro') ? 'navegacion__enlace--actual' : ''; ?>">Comprar Pases</a>
        </nav>
    </div>
</div>